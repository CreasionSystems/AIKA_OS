...
const REQUIRED_KEYS = [
  ...
  "settings.validation.invalidWritingMode",
  "settings.validation.invalidTheme",
  "settings.validation.invalidJobHistoryLimit",
  ...
  "settings.load.unavailable.io",
  "settings.load.status.label",
  "settings.load.status.unavailable",
  "settings.load.status.recovered",
  "settings.load.recovered.title",
  "settings.load.recovered.applyDefaults",
  "settings.load.fallback.invalid",
  "settings.load.retry",
  "media.title",
  "media.kind.label",
  ...
  "media.validation.invalidDuration",
  "media.validation.invalidFps",
  "media.validation.invalidMotionStrength",
  "media.validation.invalidResolution",
  "media.validation.invalidQualityPreset",
  "media.validation.fpsNotAllowed",
  "media.validation.durationNotAllowed",
  "media.validation.resolutionNotSupported",
  "media.validation.qualityNotSupported",
  "media.validation.unsupportedCombination",
  "media.validation.frameConstraint",
  "media.validation.frameNotInteger",
  "media.validation.invalidAsset",
  "media.validation.assetCount",
  "media.composer.status.checking",
  "media.diagnostic.summary",
  "media.diagnostic.missingDependency",
  "media.diagnostic.insufficientVram",
  "media.diagnostic.unsupportedConfiguration",
  "media.diagnostic.applySuggested",
  "media.diagnostic.details",
  "media.diagnostic.status.label",
  "media.diagnostic.status.blocked",
  "media.diagnostic.turn.missingDependency",
  "media.diagnostic.turn.insufficientVram",
  "media.diagnostic.turn.unsupportedConfiguration",
  "media.job.failed",
  "media.job.incomplete",
  "media.composer.frameSuggestion.title",
  "media.composer.frameSuggestion.apply",
  "media.composer.suggestions.title",
  "media.composer.suggestions.apply",
  "media.composer.suggestions.dismiss",
  "media.composer.reason.explicitDuration",
  "media.composer.reason.slowMotion",
  "media.composer.reason.cinematic",
  "media.composer.turn.draftWithSuggestions_other",
  "media.composer.params.title",
  "media.composer.params.durationSec",
  "media.composer.params.fps",
  "media.composer.params.resolution",
  "media.composer.params.qualityPreset",
  "media.composer.params.motionStrength",
  "media.composer.params.unset",
  "media.composer.quality.draft",
  "media.composer.quality.standard",
  "media.composer.quality.high",
  "media.composer.asset.video",
  "media.composer.asset.audio",
  "media.composer.turn.user",
  "media.composer.turn.assistant",
  "media.composer.turn.followUp",
  "media.composer.turn.draft",
  "media.composer.error.copyFailed",
  "media.composer.error.copyLabel",
  ...
  "media.composer.status.copied",
  "media.composer.status.label",
  "media.composer.status.copyLabel",
  ...
  "writing.validation.unsupportedMode",
  "writing.validation.emptyPrompt",
  "writing.validation.promptTooLong",
  "writing.validation.temperatureNotAllowed",
  "writing.validation.invalidMaxTokens",
  "writing.error.generationFailed",
  "update.title",
  "update.action.check",
  "update.status.idle",
